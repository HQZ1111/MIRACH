# _set_bundles.ps1 - set the profile bundle list explicitly (keep dsh-pocket OUT: it fails to apply
# with "cannot get property webServer without inject" and takes the whole plugin tree down)
