...
// mirach 适配：hermes 的 Codicon（VS Code 图标集）→ lucide 同义图标
function Codicon({ name, size }: { name: string; size: string }) {
  return name === 'debug-pause'
    ? <Pause style={{ width: size, height: size }} />
