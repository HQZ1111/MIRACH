import { usePasteDetection } from "@/components/zosma/hooks/usePasteDetection";
import { useFileMention } from "@/components/zosma/hooks/useFileMention";
import { trackEvent } from "@/components/zosma/lib/telemetry";
import { useLang } from "@/components/zosma/contexts/LanguageContext";
import { findModel } from "@/components/zosma/lib/model-key";
import type { FileAttachment, ModelInfo } from "@/components/zosma/types";
...
export const MessageInput = forwardRef<MessageInputHandle, MessageInputProps>(
	(
		...
		const placeholder = disabled
				...
				: streaming
					? queueCount > 0
						? `${t("chat.steer")} · Alt+Enter · ${queueCount} queued`
						: t("chat.steer")
					: t("chat.placeholder");
