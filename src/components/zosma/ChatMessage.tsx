import { rehypeHighlightTerm } from "@/components/zosma/lib/rehypeHighlightTerm";
import { trackEvent } from "@/components/zosma/lib/telemetry";
import type { ChatMessage as ChatMessageType, FileAttachment, ModelInfo } from "@/components/zosma/types";
import { invoke } from "@tauri-apps/api/core";
import { Clipboard, Download, FolderOpen, User } from "lucide-react";
import { useCallback, useState } from "react";
import ReactMarkdown, { type Options as ReactMarkdownOptions } from "react-markdown";
import remarkGfm from "remark-gfm";
import zosmaMark from "@/assets/zosma-mark.png";
