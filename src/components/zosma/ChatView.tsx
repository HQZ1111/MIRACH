import { ChatMessageItem } from "@/components/zosma/ChatMessage";
import { DropZoneOverlay } from "@/components/zosma/DropZoneOverlay";
import { ErrorBanner } from "@/components/zosma/ErrorBanner";
import { InThreadFind } from "@/components/zosma/InThreadFind";
import { MessageInput } from "@/components/zosma/MessageInput";
import { useFileDrop } from "@/components/zosma/hooks/useFileDrop";
import type { FileAttachment, ChatMessage, ModelInfo } from "@/components/zosma/types";
import type { Command } from "@/components/zosma/types/commands";
...
interface ChatViewProps {
	...
	/**
	 * 隐藏自带 MessageInput（简约档输入框改由外层默认 Composer 接管，
	 * 保证切换对话风格时输入框图标按钮不变；只换消息区 UI）。
	 */
