...
function FileItem({ node, depth, isLast, parentPath, onFolderClick, onFileClick }: FileItemProps) {
...
export function FileTree({ data, className, onFolderClick, onFileClick }: FileTreeProps) {
  return (
    <div
      className={cn(
        "bg-black/20 rounded-lg border border-border/50 p-3 font-mono",
        className,
      )}
    >
      {/* Header */}
