...
// 整库移植自 hermes 桌面端 lib/voice-stop-word.ts（原样保留结构/语义），
// 仅扩充中文停止短语与 mirach 称呼前缀（数据补充，非逻辑改动）。
//
...
// spoken utterance to match.（中文短语同规则：整句才算，含"停"的实质请求不吞）
...
const ADDRESS_PREFIXES: readonly string[] = [
  'hey hermes', 'hey hermes,', 'hermes', 'hermes,', 'ok', 'okay', 'hey',
  'hey mirach', 'mirach', 'mirach,',
  '嘿hermes', '嘿 hermes', '黑hermes', '嗨hermes',
  '嘿mirach', '嘿 mirach', 'mirach',
]
